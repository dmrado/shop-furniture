        ...
        <>
            <div className="max-w-4xl mx-auto my-4 p-2 bg-white rounded-lg shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3">
                    ...
                    <div className="flex-shrink-0 w-24 h-24 sm:w-20 sm:h-20 max-w-[96px] sm:max-w-none rounded-md overflow-hidden border border-gray-200">
                        <Image
                            width={80} /* 240 / 3 = 80 */
                    ...
                    <div className="flex-grow flex flex-col justify-center items-center sm:items-start text-center sm:text-left">
                        <h1 className="text-lg sm:text-xl font-bold mb-1 text-[#505050]">
                            {' '}
                            {/* Уменьшил text-2xl/3xl до text-lg/xl, mb-2 до mb-1 */}
                            {product.name}
                        </h1>
                        ...
                        <p className="text-gray-500 text-xxs sm:text-xs italic mt-auto">
                            {' '}
                            {/* Уменьшил text-sm до text-xxs/xs */}
                            Добавлено:&nbsp;
                ...
                <div className="flex flex-wrap p-5 justify-center items-center mt-6 border-t pt-4">
                    <Link href={'/admin/products'}>
                        <button className="button_blue mr-6">
