const CartItemSkeleton = () => {
    return (
        <>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-4 bg-white rounded-lg shadow-md mb-4 mx-6 gap-4 border border-gray-100">
                {/* Checkbox skeleton */}
...
export default function Loading() {
    return (
        <div className="container mx-auto py-6">
            {[0, 1, 2].map((index) => (
                <CartItemSkeleton key={index} widthVariant={index} />
            ))}
        </div>
    )
}
