...
import { Cart } from '@/components/site/img/Cart'
import { Profile } from '@/components/site/img/Profile'
    ...
    const NavRight = () => {
        return (
            <>
                ...
                <div
                    className={`flex items-center text-white md:flex-row flex-col
            ...
            md:gap-5 md:[&>a:first-child]:mt-0
             `}
                ...
                <button
                    ...
                    onClick={closeMenu}
                >
                    <Phone width={15} height={15} className="" />
                ...
                <div className="flex items-center space-x-4">
                    ...
                    >
                        <Heart
                            width={24}
                            height={24}
                            color={isFavoritesIconHovered ? '#E99C28' : 'white'}
                    ...
                    >
                        ...
                        <Cart
                            width={24}
                            height={24}
                            color={isCartIconHovered ? '#E99C28' : 'white'}
                    ...
                    <div className="ml-12">
                        ...
                        >
                            <Profile
                                ...
                                height={24}
                                color={
                                    isProfileIconHovered ? '#E99C28' : 'white'
                                }
                                className="w-6 h-6 transform-none"
                            />
                        </Link>
        ...
        return (
            <>
                <div className="absolute left-1/2 -top-8 -translate-x-1/2">
                    <span className="bg-white text-yellow-700 text-md font-bold px-1.5 py-0.5 rounded-xl min-w-[20px] text-center shadow-sm z-30">
                        <CartTotalAmount />
                    </span>
                </div>
            </>
    ...
    return (
        <header className="fixed w-full h-[137px] shadow-md flex justify-center items-center bg-[#171613] z-50">
            <div className="flex items-center h-full">
                ...
                <div className="flex items-center flex-wrap xl:flex-nowrap justify-between md:justify-center xl:justify-between gap-y-4">
                    {/* Первая строка */}
