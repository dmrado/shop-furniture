                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 ">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="prose prose-sm text-[#383838]">
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: product.descriptionLong
                                    }}
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                <h5>
                                    Это выбирает КОНКРЕТНЫЙ вариант из
                                    ОТФИЛЬТРОВАННЫХ:{' '}
                                </h5>
                                <select
                                ...
                                >
                                    {filteredVariants.map((variant) => (
                                        ...
                                        >
                                            <p>
                                                Размеры: {variant.width}x
                                                {variant.length}. Цвет:{' '}
                                                {variant.color.code} Цена:{' '}
                                                {variant.price}
                                            </p>
                                        </option>
                                    ))}
                                ...
                                <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
                                    ...
                                    <button
                                        onClick={async () => {
                                            ...
                                            if (!selectedVariant) {
                                                throw new Error(
                                                    'Невозможно добавить в корзину: вариант продукта не выбран.'
                                                )
                                            }
                                            try {
                                                await addProductToCart(
                                                    selectedVariant.id,
                                                    quantitySelectorCount
                                                )
                                                console.log(
                                                    'Добавлено в корзину ID:',
                                                    selectedVariant.id,
                                                    quantitySelectorCount,
                                                    'штуки'
                                                )
                                        ...
                                        disabled={
                                            !selectedVariant || isCartUpdating
                                        }
