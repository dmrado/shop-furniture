        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="relative h-[453px]">
                    <div className="absolute inset-0 bg-gray-800 bg-opacity-20">
                        <div
                            className="absolute bottom-12 left-12 text-white hover:text-[#E99C28] transition-colors duration-300 cursor-pointer">
                            <h3 className="text-xl font-medium ">Гостинные</h3>
                            <button className="text-sm mt-1">Смотреть каталог →</button>
                        </div>
                    </div>
                    <img
                        src="/gostinnie.png"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="relative h-[453px]">
                    <div className="absolute inset-0 bg-gray-800 bg-opacity-20">
                        <div
                            className="absolute bottom-12 left-12 text-white hover:text-[#E99C28] transition-colors duration-300 cursor-pointer">
                            <h3 className="text-xl font-medium ">Спальни</h3>
                            <button className="text-sm mt-1">Смотреть каталог →</button>
                        </div>
                    </div>
                    <img
            ...
            <div className="flex flex-col md:flex-row mb-8 lg:px-28">
                ...
                <div className="md:w-1/3 mt-4 md:mt-0">
                    <img src="/team-decoro.png" alt="Наша команда" className="w-full"/>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
                <div className="relative h-[453px]">
                    <div className="absolute inset-0 bg-gray-800 bg-opacity-20">
                        <div className="absolute bottom-8 left-8 text-white">
                            <h3 className="text-xl font-medium">Светильники TURRI со скидкой 30%</h3>
                            <button className="text-sm underline mt-1">Смотреть →</button>
                        </div>
                    </div>
                    <img
                        src="/svetilniki.png"
                ...
                <div className="relative h-[453px]">
                    <div className="absolute inset-0 bg-gray-800 bg-opacity-20">
                        <div className="absolute bottom-8 left-8 text-white">
                            <h3 className="text-xl font-medium">Готовые проекты спален + бесплатная установка</h3>
                            <button className="text-sm underline mt-1">Смотреть →</button>
                        </div>
                    </div>
                    <img
                ...
                <div className="relative h-[453px]">
                    <div className="absolute inset-0 bg-gray-800 bg-opacity-20">
                        <div className="absolute bottom-8 left-8 text-white">
                            <h3 className="text-xl font-medium">Новая коллекция свечей из Италии</h3>
                            <button className="text-sm underline mt-1">Смотреть →</button>
                        </div>
                    </div>
                    <img
            ...
            <div className="mb-8">
                ...
                <form className="max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label className="block text-sm text-gray-600 mb-1">Компания</label>
                            <input type="text" className="w-full p-2 border border-gray-300 rounded"/>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col mb-4">
                        <div className="flex items-start mb-0 text-[#E99C28]">
                            ...
                            <p className="text-sm text-[#E99C28]">Политика конфиденциальности</p>
                        </div>
                        <a className="text-sm py-0" href="">Внимательно ознакомьтесь с нашей политикой
