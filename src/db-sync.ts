...
import { AccountModel, AddressModel, CartModel, ColorModel, OrderModel, OrderedProductsModel,
    // OuruserModel,
    ProductModel, SessionModel, StockModel, } from '@/db/models'
...
const registeredModels = [
    // Admin, Post, Alert,
    AddressModel, ColorModel, ProductModel, OrderedProductsModel, OrderModel, StockModel, /*OuruserModel*/, CartModel, SessionModel, AccountModel, AuthUser, VerificationTokenModel ]
